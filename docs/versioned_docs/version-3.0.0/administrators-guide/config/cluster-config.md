...
You can also modify cluster configuration via [non-interactive](../../ignite-cli-tool.md#non-interactive-cli-mode) CLI mode without starting the CLI tool first.
...
| Property | Default | Description | Changeable | Requires Restart | Acceptable Values |
|----------|---------|-------------|------------|------------------|-------------------|
| exporters |  | The list of [metric](../metrics/configuring-metrics.md) exporters currently used. | Yes | No | Valid exporters |
