...
Ignite 3 is focused on SQL, and SQL API is the primary way to work with the data. You can read more about supported SQL statements in the [SQL Reference](../../sql-reference/ddl.md) section. Here is how you can send SQL requests:
