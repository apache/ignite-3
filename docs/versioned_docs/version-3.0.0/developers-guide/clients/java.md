...
To pass [authentication](../../administrators-guide/security/authentication.md) information, use the `IgniteClientAuthenticator` class and pass it to `IgniteClient` builder:
