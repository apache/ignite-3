...
sidebar_label: Distribution Zones
---
...
:::note
The example above assumes that there are nodes that have the attribute set as shown in the [node filtering](../sql-reference/distribution-zones.md) example.
:::
