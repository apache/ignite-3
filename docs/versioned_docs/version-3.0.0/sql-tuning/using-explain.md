---
title: How to Improve Queries With EXPLAIN Command
sidebar_label: Using EXPLAIN
---
...
- `SearchBounds` - Shows index lookup constraints: `searchBounds: <v1, v2, ...>` for an exact lookup, `[<l1, l2>..<u1, u2>)` for a range lookup.
