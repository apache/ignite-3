...
:::note
Using the [Helm chart](installing-to-k8s.md) is recommended, however, if you choose not to use Helm, this guide will walk you through installing Apache Ignite on Kubernetes.
:::
