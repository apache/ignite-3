---
title: Migration From Apache Ignite 2
sidebar_label: Migration From Apache Ignite 2
---
...
All clients in Apache Ignite 3 are "thin", and use a similar `clientConnector` configuration. See [Apache Ignite Clients](../../developers-guide/clients/index.md) section for more information on configuring client connector.

#### Network Configuration

Node network configuration is now performed in the `network` section of the [node configuration](../../administrators-guide/config/node-config.md).
...
You can configure REST properties in [node configuration](../../administrators-guide/config/node-config.md).
...
In the current release, only `log` sink are supported. You can configure events as described in the [Events](../../developers-guide/events/index.md) section.
...
For instructions on configuring metrics, see [Metrics Configuration](../../administrators-guide/metrics/configuring-metrics.md).
