...
sidebar_label: Installing Using Docker
---
...
You can use a docker-compose file to start an entire cluster in docker. You can create a docker-compose file and run a 3-node cluster. See the [Getting Started](../quick-start/getting-started-guide.md#optional-starting-multiple-ignite-nodes-in-docker) guide for the docker-compose configuration.
...
:::note
It is not recommended to run the CLI tool in docker. Instead, we recommend to [download and install](installing-using-zip.md) CLI tool locally.
:::
