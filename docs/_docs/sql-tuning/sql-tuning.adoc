...
For each table, Ignite tracks the number of modifications and if such modifications exceed a configurable threshold - statistics are considered stale and:
