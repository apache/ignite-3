...
It is also worth noting that the server part remains compatible with previous versions of the driver. This means that driver version 3.1 can successfully connect to server version 3.2.
