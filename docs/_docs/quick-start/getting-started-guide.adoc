...
This guide provides essential details on how to start working with Ignite 3.0 by using the Ignite CLI tool, including the following information:
...
[source, shell]
----
ignite node start --config=examples/config/ignite-config.json myFirstNode
----
...
Apache Ignite alpha comes with examples that are configured as a separate Maven project located in the *examples* folder.

The project includes the following examples:

* `TableExample` demonstrates the usage of the `org.apache.ignite.table.Table` API to create a table. It also shows how you can get data from a table, or insert a line into a table.
