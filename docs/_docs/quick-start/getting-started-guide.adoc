...
[source,shell, subs="attributes,specialchars"]
----
Expand-Archive ignite3-db-3.0.0.zip -DestinationPath .
Expand-Archive ignite3-cli-3.0.0.zip -DestinationPath .
----

tab:Windows (CMD)[]
[source,shell, subs="attributes,specialchars"]
----
unzip -xf ignite3-db-3.0.0.zip
unzip -xf ignite3-cli-3.0.0.zip
----
--
