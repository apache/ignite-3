...
In this guide we will use a link:../installation/installing-using-zip[zip] archive installation. To start an Ignite node,
...
tab:Linux[]
----
sh ignite3db-3.0.0-beta1/bin/ignite3db.sh start
----

tab:Windows[]
NOTE: You need to install Java in Bash environment to run Ignite on Windows.
----
bash ignite3db-3.0.0-beta1\bin\ignite3db.sh start
----
--
...
After you are done working on the cluster, you need to stop the node. Use the command below:
...
tab:Linux[]
----
sh ignite3db-3.0.0-beta1/bin/ignite3db.sh stop
----

tab:Windows[]
----
bash ignite3db-3.0.0-beta1\bin\ignite3db.sh stop
----
--
