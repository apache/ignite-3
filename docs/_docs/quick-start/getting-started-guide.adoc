...
tab:Linux[]
----
ignite3db-3.0.0-beta1/bin/ignite3db start
----

tab:Windows[]
NOTE: You need to install Java in Bash environment to run Ignite on Windows.
----
bash ignite3db-3.0.0-beta1\bin\ignite3db start
----
--
...
tab:Linux[]
----
ignite3db-3.0.0-beta1/bin/ignite3db stop
----

tab:Windows[]
----
bash ignite3db-3.0.0-beta1\bin\ignite3db stop
----
--
