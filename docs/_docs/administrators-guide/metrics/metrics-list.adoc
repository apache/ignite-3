...
| fsmcaller.disruptor.Stripes | The histogram of distribution data by stripes in the state machine for partitions.
| fsmcaller.disruptor.Batch | The histogram of the batch size to handle in the state machine for partitions.
| logmanager.disruptor.Batch | The histogram of the batch size to handle in the log for partitions.
| logmanager.disruptor.Stripes | The histogram of distribution data by stripes in the log for partitions.
| nodeimpl.disruptor.Batch | The histogram of the batch size to handle node operations for partitions.
| nodeimpl.disruptor.Stripes | The histogram of distribution data by stripes for node operations for partitions.
| readonlyservice.disruptor.Stripes | The histogram of distribution data by stripes for read-only operations for partitions.
| readonlyservice.disruptor.Batch | The histogram of the batch size to handle read-only operations for partitions.
| groups.localLeadersCount | Number of raft groups where this node is the leader.
|=======================================================================
