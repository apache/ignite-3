...
|======
|Property|Default|Description|Changeable|Requires Restart|Acceptable Values
|checkInterval|60000|How often the data is checked for eviction threshold, in milliseconds.| Yes | Yes | 1 - inf
|======
...
|======
|Property|Default|Description|Changeable|Requires Restart|Acceptable Values
|batchSize|1000|The number of items that can be expired at once.| Yes | Yes | 1 - inf
|checkInterval|600000|How often the data is checked for expiration, in milliseconds.| Yes | Yes | 1 - inf
|parallelismLevel|1|The number of threads used for data expiry.| Yes | Yes | 1 - Integer.MAX_VALUE
|======
