...
[source,shell]
----
unzip ignite3-3.0.0-beta1.zip && cd ignite-3-beta1
----
...
[source,shell]
----
Expand-Archive ignite3-3.0.0-beta1.zip -DestinationPath . ; cd ignite-3-beta1
----

tab:Windows (CMD)[]
[source,shell]
----
tar -xf ignite3-3.0.0-beta1.zip & cd ignite-3-beta1
----
--
