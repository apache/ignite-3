...
[source,shell]
----
curl -L "https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=ignite/3.0.0-beta1/apache-ignite-3.0.0-beta1.zip" -o apache-ignite-3.0.0-beta1.zip
----
...
[source,shell]
----
unzip ignite-3-beta1.zip && cd ignite-3-beta1
----
...
[source,shell]
----
Expand-Archive ignite-3-beta1.zip -DestinationPath . ; cd ignite-3-beta1
----

tab:Windows (CMD)[]
[source,shell]
----
tar -xf ignite-3-beta1.zip & cd ignite-3-beta1
----
--
