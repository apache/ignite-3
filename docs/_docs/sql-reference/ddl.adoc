...
* `column_name` - specifies the column of the table to index.
* ASC - specifies that the column should be sorted in an ascending order.
* DESC - specifies that the column should be sorted in a descending order
