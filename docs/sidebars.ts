 ...
 *
 * Complete navigation structure with all 86 converted pages.
      ...
      items: [
        {
          ...
          items: ['develop/ignite-clients/java-client', 'develop/ignite-clients/dotnet-client', 'develop/ignite-clients/cpp-client'],
        },
        {
          type: 'category',
          label: 'Connect to Ignite',
          link: {type: 'generated-index'},
          items: ['develop/connect-to-ignite/jdbc', 'develop/connect-to-ignite/odbc', 'develop/connect-to-ignite/odbc-connection-string', 'develop/connect-to-ignite/odbc-querying-data', 'develop/connect-to-ignite/python'],
        },
        {
          type: 'category',
        ...
        },
        {
          ...
          label: 'Integrate',
          link: {type: 'generated-index'},
          items: ['develop/integrate/spring-boot', 'develop/integrate/spring-data', 'develop/integrate/ado-net', 'develop/integrate/linq'],
        },
      ],
    },
      ...
      items: [
        {
          ...
          label: 'Installation',
          link: {type: 'generated-index'},
          items: ['configure-and-operate/installation/install-zip', 'configure-and-operate/installation/install-deb-rpm', 'configure-and-operate/installation/install-docker', 'configure-and-operate/installation/install-kubernetes'],
        },
        {
          type: 'category',
          label: 'Configuration',
          ...
          items: [
            ...
            'configure-and-operate/configuration/config-storage-overview',
        ...
        },
        {
          ...
          label: 'Monitoring',
          link: {type: 'generated-index'},
          items: ['configure-and-operate/monitoring/config-metrics', 'configure-and-operate/monitoring/available-metrics', 'configure-and-operate/monitoring/metrics-system-views'],
        },
        {
          type: 'category',
    ...
    // Understand (15 pages)
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            'understand/architecture/storage-architecture',
            {
              ...
              link: {type: 'generated-index'},
              items: ['understand/architecture/storage-engines/aipersist', 'understand/architecture/storage-engines/rocksdb', 'understand/architecture/storage-engines/aimem'],
            },
        ...
        },
        {
          ...
          label: 'Performance',
          link: {type: 'generated-index'},
          items: ['understand/performance/using-explain', 'understand/performance/explain-operators'],
        },
      ],
    },
          ...
          items: [
            {
              ...
              link: {type: 'doc', id: 'api-reference/native-clients/java/java-index'},
              items: [
            ...
            },
            {
              type: 'category',
              label: '.NET API',
              link: {type: 'doc', id: 'api-reference/native-clients/dotnet/dotnet-index'},
              items: [
            ...
            },
            {
              type: 'category',
              label: 'C++ API',
              link: {type: 'doc', id: 'api-reference/native-clients/cpp/cpp-index'},
              items: [
