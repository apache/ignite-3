...
### Data Access APIs
- [Tables API](./tables-api) - Record and key-value views with typed and tuple access patterns
- [LINQ API](./linq-api) - Language-integrated queries with strongly-typed expressions
- [Data Streamer API](./data-streamer-api) - Bulk loading with custom server-side receivers and error handling
- [SQL API](./sql-api) - Query execution with parameterized statements and lazy materialization
- [ADO.NET API](./ado-net-api) - Standard ADO.NET database connectivity
