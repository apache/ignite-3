...
Another way to cancel queries is by using the SQL [KILL QUERY](/docs/sql/reference/operational-commands#kill-query) command. The query id can be retrieved via the `SQL_QUERIES` [system view](/docs/administrators-guide/metrics/system-views).
