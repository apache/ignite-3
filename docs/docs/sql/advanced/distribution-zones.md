...
:::note
This can also be done via the [Java API](/docs/3.1.0/develop/work-with-data/java-to-tables).
:::
...
:::note
The example above assumes that there are nodes that have the attribute set as shown in the [node filtering](/docs/3.1.0/sql/advanced/distribution-zones) example.
:::
