...
Apache Ignite supports the [`EXPLAIN PLAN FOR`](/docs/sql-reference/operational-commands#explain) statement that can be used to read the execution plan of a query.
...
Apache Ignite supports the [`EXPLAIN MAPPING FOR`](/docs/sql-reference/operational-commands#explain) statement that can be used to track how the query is split and what nodes the subqueries are executed on.
...
- All required [DDL operations](/docs/sql-reference/ddl);
- Assigning [access permissions](/docs/sql-reference/access-control);
