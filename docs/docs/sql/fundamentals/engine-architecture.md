...
- **Cluster-wide System Views**: [System views](/docs/3.1.0/administrators-guide/metrics/system-views) in Apache Ignite 3 provide cluster-wide information, dynamically updated.
