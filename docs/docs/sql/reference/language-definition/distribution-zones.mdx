...
:::note
The example above assumes that there are nodes that have the attribute set as shown in the [node filtering](/docs/3.1.0/sql/reference/language-definition/distribution-zones) example.
:::
