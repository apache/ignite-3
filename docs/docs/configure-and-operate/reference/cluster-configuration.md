...
You can also modify cluster configuration via [non-interactive](/docs/developers-guide/ignite-cli-tool#non-interactive-cli-mode) CLI mode without starting the CLI tool first.
