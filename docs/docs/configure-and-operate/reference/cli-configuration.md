...
Apache Ignite [CLI](/docs/3.1.0/developers-guide/ignite-cli-tool#interactive-cli-mode) supports configuration profiles to manage different sets of settings.
