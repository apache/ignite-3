...
:::note
Using the [Helm chart](/docs/3.1.0/configure-and-operate/installation/helm) is recommended, however, if you choose not to use Helm, this guide will walk you through installing Apache Ignite on Kubernetes.
:::
