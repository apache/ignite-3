...
| STATE | STRING | Partition status. Possible values: `AVAILABLE`, `DEGRADED`, `READ_ONLY`, `UNAVAILABLE`. See [Disaster Recovery](/docs/configure-and-operate/operations/disaster-recovery-partitions) documentation for more information. |
...
| TYPE | STRING | Column type. Can by any of the [supported types](/docs/sql-reference/data-types). |
