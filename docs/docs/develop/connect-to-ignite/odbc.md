...
Ignite 3 includes an ODBC driver that allows you both to select and to modify data stored in a distributed cache by using standard SQL queries and native ODBC API. ODBC driver uses your [client connection configuration](/docs/developers-guide/clients/overview).
...
For more information on configuring client connector, see [Client Connector Configuration](/docs/developers-guide/clients/overview#client-connector-configuration).
