...
If the cluster uses [basic authorization](/docs/administrators-guide/security/authentication#basic-authentication), you need to provide user `identity` and `secret` to authorize on it, for example:
