...
If the cluster uses [basic authorization](/docs/3.1.0/administrators-guide/security/authentication#basic-authentication), you need to provide user `identity` and `secret` to authorize on it, for example:
