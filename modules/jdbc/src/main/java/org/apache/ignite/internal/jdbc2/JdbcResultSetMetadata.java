...
public class JdbcResultSetMetadata implements ResultSetMetaData {
    ...
    public int isNullable(int column) throws SQLException {
        return column(column).nullable() ? columnNullable : columnNoNulls;
    }
    ...
    public String getColumnLabel(int column) throws SQLException {
        ColumnMetadata metadata = column(column);
    ...
    public String getSchemaName(int column) throws SQLException {
        ColumnMetadata.ColumnOrigin origin = column(column).origin();
        // Compatibility with the existing driver
    ...
    public int getPrecision(int column) throws SQLException {
        return column(column).precision();
    }

    /** {@inheritDoc} */
    @Override
    public int getScale(int column) throws SQLException {
        return column(column).scale();
    }
    ...
    public int getColumnType(int column) throws SQLException {
        ColumnType columnType = column(column).type();
    ...
    private ColumnMetadata column(int idx) throws SQLException {
