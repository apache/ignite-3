...
public class JdbcStatement2 implements Statement {
    ...
    void execute0(Set<QueryModifier> queryModifiers, String sql, Object[] args) throws SQLException {
        ...
        if (!connection.getAutoCommit()) {
            throw new IllegalStateException("Explicit transactions are not supported yet.");
        }
        ...
        if (queryModifiers.contains(QueryModifier.ALLOW_MULTISTATEMENT)) {
            throw new IllegalStateException("Multi-statements are not supported yet.");
        }
        ...
        if (queryTimeoutMillis > 0) {
            stmtBuilder.queryTimeout(queryTimeoutMillis, TimeUnit.MILLISECONDS);
        }
    ...
    public void setMaxFieldSize(int max) throws SQLException {
        ...
        throw new SQLFeatureNotSupportedException("Field size limit is not supported.");
    }
    ...
    public void setCursorName(String name) throws SQLException {
        ...
        throw new SQLFeatureNotSupportedException("Setting cursor name is not supported.");
    }
