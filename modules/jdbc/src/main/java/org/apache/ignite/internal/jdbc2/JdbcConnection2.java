...
public class JdbcConnection2 implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        if (autoGeneratedKeys == Statement.RETURN_GENERATED_KEYS) {
            throw new SQLFeatureNotSupportedException("Returning auto-generated keys is not supported.");
        }
    ...
    public void setTransactionIsolation(int level) throws SQLException {
        ...
        switch (level) {
            ...
            case TRANSACTION_NONE:
                throw new SQLException("Cannot set transaction isolation level to TRANSACTION_NONE.");
