...
public class JdbcConnection2 implements Connection {
    ...
    public boolean setShardingKeyIfValid(ShardingKey shardingKey, ShardingKey superShardingKey,
        ...
        throw new SQLFeatureNotSupportedException("Sharding keys are not supported.");
    }
    ...
    private static void checkCursorOptions(
        ...
        if (resHoldability != HOLD_CURSORS_OVER_COMMIT) {
            throw new SQLFeatureNotSupportedException(
                    "Invalid result set holdability (only hold cursors over commit option is supported).");
        }
    }
