...
class UpdatePrevWiLinkHandler implements PageHandler<Long, Object> {
    static final UpdatePrevWiLinkHandler INSTANCE = new UpdatePrevWiLinkHandler();
    ...
    public Object run(
        ...
        writePartitionless(pageAddr + payloadOffset + WiLinkableRowVersion.PREV_WRITE_INTENT_LINK_OFFSET, newPrevWiLink);
