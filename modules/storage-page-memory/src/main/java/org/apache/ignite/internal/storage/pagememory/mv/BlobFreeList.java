...
/**
 * {@link FreeList} for {@link Blob} instances.
 */
public class BlobFreeList extends AbstractFreeList<Blob> {
    private static final IgniteLogger LOG = Loggers.forClass(BlobFreeList.class);
     ...
     * @throws IgniteInternalCheckedException If failed.
     */
    public void insertBlob(Blob blob) throws IgniteInternalCheckedException {
        insertDataRow(blob, statHolder);
    }

    /**
     * Removes a blob by link.
     *
     * @param link Blob link.
     * @throws IgniteInternalCheckedException If failed.
     */
    public void removeBlobByLink(long link) throws IgniteInternalCheckedException {
        removeDataRowByLink(link, statHolder);
    }
