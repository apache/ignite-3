...
/** Metric source for the {@link CriticalSingleThreadExecutor}. */
public class CriticalSingleThreadExecutorMetricSource implements MetricSource {
     ...
     */
    public CriticalSingleThreadExecutorMetricSource(String group, String name) {
        this.group = group;
        this.name = name;
    }
