...
public class RequestBalancingTest {
    ...
    void setUp() {
        ...
        server1 = AbstractClientTest.startServer(0, ignite, "s1");
        server2 = AbstractClientTest.startServer(0, ignite, "s2");
        server3 = AbstractClientTest.startServer(0, ignite, "s3");
    }
