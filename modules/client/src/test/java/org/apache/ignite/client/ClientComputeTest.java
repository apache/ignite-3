...
public class ClientComputeTest {
    ...
    private void initServers(Function<Integer, Boolean> shouldDropConnection) {
        ...
        server1 = new TestServer(0, ignite, shouldDropConnection, null, "s1", clusterId, null);
        server2 = new TestServer(0, ignite, shouldDropConnection, null, "s2", clusterId, null);
        server3 = new TestServer(0, ignite, shouldDropConnection, null, "s3", clusterId, null);
    }
}
