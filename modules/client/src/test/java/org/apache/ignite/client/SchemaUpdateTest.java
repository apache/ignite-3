...
public class SchemaUpdateTest {
    ...
    public void testMultipleParallelOperationsRequestSchemaOnce() {
        ...
        server = new TestServer(10000, ignite(), null, idx -> responseDelay, "n", UUID.randomUUID(), null);
        client = startClient();
    ...
    public void testFailedSchemaLoadFutureIsRetried() {
        ...
        server = new TestServer(10000, ignite(), shouldDropConnection, null, "n", UUID.randomUUID(), null);
        client = startClient();
