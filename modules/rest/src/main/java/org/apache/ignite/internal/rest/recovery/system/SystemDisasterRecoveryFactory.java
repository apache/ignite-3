...
/**
 * Factory that defines beans required for the System Disaster Recovery Rest module.
 */
@Factory
public class SystemDisasterRecoveryFactory implements RestFactory {
    ...
    public SystemDisasterRecoveryFactory(SystemDisasterRecoveryManager systemDisasterRecoveryManager) {
