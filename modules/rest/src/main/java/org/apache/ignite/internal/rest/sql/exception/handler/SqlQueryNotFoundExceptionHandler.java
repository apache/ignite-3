...
/**
 * REST exception handler for {@link SqlQueryNotFoundExceptionHandler}.
 */
@Singleton
@Requires(classes = {SqlQueryNotFoundExceptionHandler.class, ExceptionHandler.class})
public class SqlQueryNotFoundExceptionHandler implements
        ExceptionHandler<SqlQueryNotFoundException, HttpResponse<? extends Problem>> {
    @Override
