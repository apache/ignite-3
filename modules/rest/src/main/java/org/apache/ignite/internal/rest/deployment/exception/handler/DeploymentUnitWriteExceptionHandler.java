...
public class DeploymentUnitWriteExceptionHandler
        implements ExceptionHandler<DeploymentUnitWriteException, HttpResponse<? extends Problem>> {

    @Override
    public HttpResponse<? extends Problem> handle(HttpRequest request, DeploymentUnitWriteException exception) {
