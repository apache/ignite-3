 ...
 */
@Singleton
@Requires(classes = {DeploymentUnitAlreadyExistsException.class, ExceptionHandler.class})
public class DeploymentUnitAlreadyExistExceptionHandler
        implements ExceptionHandler<DeploymentUnitAlreadyExistsException, HttpResponse<? extends Problem>> {
    @Override
    public HttpResponse<? extends Problem> handle(HttpRequest request, DeploymentUnitAlreadyExistsException exception) {
