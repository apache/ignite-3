...
public interface InputStreamCollector {
     ...
     * 
     * <p>This method closes all input streams that have been added to this collector and
     * clears the internal collection. After calling this method, the collector returns to
