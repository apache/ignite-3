...
package org.apache.ignite.internal.datareplication.network;

import static org.apache.ignite.internal.datareplication.network.PartitionReplicationMessageGroup.GROUP_TYPE;

import org.apache.ignite.internal.datareplication.network.command.BuildIndexCommand;
...
import org.apache.ignite.internal.datareplication.network.command.TimedBinaryRowMessage;
import org.apache.ignite.internal.datareplication.network.command.UpdateAllCommand;
import org.apache.ignite.internal.datareplication.network.command.UpdateCommand;
import org.apache.ignite.internal.datareplication.network.command.WriteIntentSwitchCommand;
import org.apache.ignite.internal.datareplication.network.disaster.LocalPartitionStateMessage;
import org.apache.ignite.internal.datareplication.network.disaster.LocalPartitionStatesRequest;
import org.apache.ignite.internal.datareplication.network.disaster.LocalPartitionStatesResponse;
import org.apache.ignite.internal.datareplication.network.message.HasDataRequest;
import org.apache.ignite.internal.datareplication.network.message.HasDataResponse;
...
import org.apache.ignite.internal.datareplication.network.raft.SnapshotMvDataResponse;
import org.apache.ignite.internal.datareplication.network.raft.SnapshotMvDataResponse.ResponseEntry;
import org.apache.ignite.internal.datareplication.network.raft.SnapshotTxDataRequest;
import org.apache.ignite.internal.datareplication.network.raft.SnapshotTxDataResponse;
import org.apache.ignite.internal.datareplication.network.replication.BinaryRowMessage;
import org.apache.ignite.internal.datareplication.network.replication.BinaryTupleMessage;
import org.apache.ignite.internal.datareplication.network.replication.BuildIndexReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadOnlyDirectMultiRowReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadOnlyDirectSingleRowReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadOnlyMultiRowPkReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadOnlyScanRetrieveBatchReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadOnlySingleRowPkReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadWriteMultiRowPkReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadWriteMultiRowReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadWriteScanRetrieveBatchReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadWriteSingleRowPkReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadWriteSingleRowReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ReadWriteSwapRowReplicaRequest;
import org.apache.ignite.internal.datareplication.network.replication.ScanCloseReplicaRequest;
