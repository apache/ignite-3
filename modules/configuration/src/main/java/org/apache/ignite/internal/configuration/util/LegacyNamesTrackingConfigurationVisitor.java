...
public abstract class LegacyNamesTrackingConfigurationVisitor<T> implements ConfigurationVisitor<T> {
    ...
    /**
     * To be used instead of {@link ConfigurationVisitor#visitNamedListNode(Field, String, NamedListNode)} (String, NamedListNode)}.
     *
     * @param key  Name of the node retrieved from its holder object.
