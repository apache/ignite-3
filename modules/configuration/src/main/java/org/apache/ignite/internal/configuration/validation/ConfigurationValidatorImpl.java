...
public class ConfigurationValidatorImpl implements ConfigurationValidator {
    ...
    public static class ConfigurationValidatorImplFactory {
        ...
        @Singleton
        @Inject
        @Named("distributedWithDefaults")
        public static ConfigurationValidatorImpl distributedValidatorsWithDefault(
                ConfigurationTreeGenerator generator,
                ConfigurationModules modules
        ) {
            return withDefaultValidators(generator, modules.distributed().validators());
        }
    }
}
