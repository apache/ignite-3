...
public class NamedListNodeTest {
    ...
    public void storageData() throws Exception {
        ...
        CompletableFuture<Map<String, ? extends Serializable>> storageValues = storage.readAllOnStart().thenApply(Data::values);
        ...
        storageValues = storage.readAllOnStart().thenApply(Data::values);
        ...
        assertThat(storage.readAllOnStart().thenApply(Data::values), willBe(anEmptyMap()));
    }
