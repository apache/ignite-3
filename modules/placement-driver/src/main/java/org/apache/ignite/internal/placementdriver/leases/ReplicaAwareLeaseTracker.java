...
public class ReplicaAwareLeaseTracker extends AbstractEventProducer<PrimaryReplicaEvent, PrimaryReplicaEventParameters> implements
    ...
    public CompletableFuture<ReplicaMeta> awaitPrimaryReplica(
        ...
        return delegate.awaitPrimaryReplica(new TablePartitionId(tableId, groupId.partitionId()), timestamp, timeout, unit)
                .thenCompose(replicaMeta -> {
                    ...
                    AwaitReplicaRequest awaitReplicaReq = REPLICA_MESSAGES_FACTORY.awaitReplicaRequest()
                            .groupId(new TablePartitionId(tableId, groupId.partitionId()))
                            .build();
