...
class RaftLogCheckpointer {
    ...
    private final LongConsumer onIndexFileCreated;
    ...
    RaftLogCheckpointer(
            ...
            int maxQueueSize,
            LongConsumer onIndexFileCreated
    ) {
        this.indexFileManager = indexFileManager;
        this.failureProcessor = failureProcessor;
        this.onIndexFileCreated = onIndexFileCreated;
        ...
        public void run() {
            while (true) {
                try {
                    ...
                    onIndexFileCreated.accept(indexFileSize);
