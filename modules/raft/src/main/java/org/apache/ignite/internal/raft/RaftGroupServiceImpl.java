...
public class RaftGroupServiceImpl implements RaftGroupService {
    ...
    public CompletableFuture<Void> addPeer(Peer peer) {
        ...
        Function<Peer, AddPeerRequest> requestFactory = targetPeer -> factory.addPeerRequest()
                ...
                .groupId(groupId)
                .peerId(peerId(peer))
                .casualityToken(Configuration.NO_CASUALITY_TOKEN)
                .build();
    ...
    public CompletableFuture<Void> changePeersAndLearners(PeersAndLearners peersAndLearners, long term, long casualityToken) {
        ...
        if (leader == null) {
            return refreshLeader(() -> "changePeersAndLearners")
                    .thenCompose(res -> changePeersAndLearners(peersAndLearners, term, casualityToken));
        }
    ...
    public CompletableFuture<Void> changePeersAndLearnersAsync(PeersAndLearners peersAndLearners, long term, long casualityToken) {
        ...
        if (leader == null) {
            return refreshLeader(() -> "changePeersAndLearnersAsync")
                    .thenCompose(res -> changePeersAndLearnersAsync(peersAndLearners, term, casualityToken));
        }
