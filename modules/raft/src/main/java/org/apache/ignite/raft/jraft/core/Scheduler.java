...
public interface Scheduler {
     ...
     * @return a ScheduledFuture representing pending completion of the task and whose {@code get()} method will return {@code null} upon
     * completion scheduled for execution
     */
     ...
     * period; that is executions will commence after {@code initialDelay} then {@code initialDelay+period}, then {@code initialDelay + 2 *
     * period}, and so on. If any execution of the task encounters an exception, subsequent executions are suppressed. Otherwise, the task
     * will only terminate via cancellation or termination of the executor.  If any execution of this task takes longer than its period,
     ...
     * @return a ScheduledFuture representing pending completion of the task, and whose {@code get()} method will throw an exception upon
     * cancellation
     */
