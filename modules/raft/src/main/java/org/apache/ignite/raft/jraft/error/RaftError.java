...
public enum RaftError {
    ...
    /**
     * Rejected by user-supplied validator. If ActionRequest gets such a response, the corresponding command has not been either saved
     * to log or applied on any node; also, the Raft client should not retry the same ActionRequest attempt as it will never succeed.
     */
