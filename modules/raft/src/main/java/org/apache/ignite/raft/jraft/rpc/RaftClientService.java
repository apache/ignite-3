...
public interface RaftClientService extends ClientService {
     ...
     */
    Future<Message> preVote(final PeerId peerId, final RpcRequests.RequestVoteRequest request,
     ...
     * @return a future with result
     */
    Future<Message> requestVote(final PeerId peerId, final RpcRequests.RequestVoteRequest request,
        final RpcResponseClosure<RpcRequests.RequestVoteResponse> done);
     ...
     * @return a future with result
     */
    Future<Message> appendEntries(final PeerId peerId, final RpcRequests.AppendEntriesRequest request,
     ...
     */
    Future<Message> installSnapshot(final PeerId peerId, final RpcRequests.InstallSnapshotRequest request,
     ...
     * @return a future result
     */
    Future<Message> getFile(final PeerId peerId, final RpcRequests.GetFileRequest request, final int timeoutMs,
     ...
     * @return a future result
     */
    Future<Message> timeoutNow(final PeerId peerId, final RpcRequests.TimeoutNowRequest request,
