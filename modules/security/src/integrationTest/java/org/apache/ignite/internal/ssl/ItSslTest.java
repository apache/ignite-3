...
public class ItSslTest extends BaseIgniteAbstractTest {
    ...
    class ClusterWithoutSsl {
        ...
        String sslDisabledBoostrapConfig = "ignite {\n"
                ...
                + "    ssl.enabled: false\n"
                + "    port: {}\n"
                + "    nodeFinder.netClusterNodes: [ {}, \"localhost:3355\", \"localhost:3356\" ]\n"
                + "  }\n"
    ...
    class ClusterWithSsl {
        ...
        String sslEnabledBoostrapConfig = "ignite {\n"
                ...
                + "    }\n"
                + "    port: {}\n"
                + "    nodeFinder.netClusterNodes: [ {}, \"localhost:3345\", \"localhost:3346\" ]\n"
                + "  }\n"
                + "  clientConnector.port: {}\n"
                + "  clientConnector.ssl {\n"
                + "    enabled: true\n"
    ...
    class ClusterWithSslAndClientAuth {
        ...
        String sslEnabledBoostrapConfig = "ignite {\n"
                ...
                + "    }\n"
                + "    port: {}\n"
                + "    nodeFinder.netClusterNodes: [ {}, \"localhost:3365\", \"localhost:3366\" ]\n"
                + "  }\n"
                + "  clientConnector.port: {}\n"
                + "  clientConnector.ssl {\n"
                + "    enabled: true\n"
