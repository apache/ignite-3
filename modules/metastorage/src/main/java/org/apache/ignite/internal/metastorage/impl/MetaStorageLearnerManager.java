...
class MetaStorageLearnerManager {
    ...
    CompletableFuture<Void> resetLearners(RaftGroupService raftService, long term, long casualityToken) {
        return updateConfigUnderLock(() -> logicalTopologyService.validatedNodesOnLeader()
                .thenCompose(validatedNodes -> updateConfigUnderLock(() -> {
                    ...
                    return raftService.changePeersAndLearnersAsync(newPeerConfiguration, term, casualityToken);
                })));
    }
