...
class ItKvRecordApiThreadingTest extends ClusterPerClassIntegrationTest {
    ...
    private enum KeyValueViewAsyncOperation {
        ...
        REMOVE_EXACT_ASYNC((view, context) -> view.removeExactAsync(null, context.key, context.usualValue)),
        ...
        REPLACE_EXACT_ASYNC((view, context) -> view.replaceExactAsync(null, context.key, context.usualValue, context.anotherValue)),
