...
class PartitionMoverTest extends BaseIgniteAbstractTest {
    ...
    public void testChangePeersAndLearnersAsyncRetryLogic() {
        ...
        assertThat(partitionMover.movePartition(PEERS_AND_LEARNERS, TERM, Configuration.NO_CASUALITY_TOKEN), willCompleteSuccessfully());

        verify(raftService, times(3))
                .changePeersAndLearnersAsync(eq(PEERS_AND_LEARNERS), eq(TERM), eq(Configuration.NO_CASUALITY_TOKEN));
    }
    ...
    public void testComponentStop() {
        ...
        assertThrowsWithCause(() -> partitionMover.movePartition(PEERS_AND_LEARNERS, TERM, Configuration.NO_CASUALITY_TOKEN),
    ...
    public void testComponentAsyncStop() {
        ...
        assertThat(partitionMover.movePartition(PEERS_AND_LEARNERS, TERM, Configuration.NO_CASUALITY_TOKEN),
