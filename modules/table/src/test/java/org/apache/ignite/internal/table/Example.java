...
public class Example {
    ...
    public void useCase1(Table t) {
        ...
        Tuple res = t.recordView().get(Tuple.create().set("id", 1).set("orgId", 1), null);
        ...
        Employee e = employeeView.get(new Employee(1, 1), null);
        ...
        TruncatedEmployee te = truncatedEmployeeView.get(new TruncatedEmployee(1, 1), null);
    }
    ...
    public void useCase2(Table t) {
        ...
        employeeKv.get(new EmployeeKey(1, 1), null);
        ...
        TruncatedEmployee te = truncatedEmployeeKv.get(new EmployeeKey(1, 1), null);
    }
    ...
    public void useCase3(Table t) {
        ...
        final BillingRecord br = billingView.get(new BillingRecord(1), null);
    }
    ...
    public void useCase4(Table t) {
        ...
        OrderValue ov = orderKvView.get(new OrderKey(1, 1), null);
        ...
        OrderRecord orderRecord = orderRecView.get(new OrderRecord(1, 1), null);
    ...
    public void useCase5(Table t) {
        ...
        Record rec = recordView.get(new Record(1, 1), null);
    ...
    public void useCase6(Table t) {
        // Search row will allow nulls even in non-null columns.
        Tuple res = t.recordView().get(Tuple.create().set("id", 1), null);
        ...
        Employee e = employeeView.get(1L, null);
    }
    ...
    public void useCase7(Table t) {
        ...
        employeeView.put(1L, BinaryObjects.wrap(new byte[0] /* serialized Employee */), null);
    ...
    public void useCase8(Table t) {
        ...
        v1.put(1L, new Employee(), null);
        v2.put(2L, new Employee2(), null);
        v3.put(3L, new Employee2(), null);
        v4.put(4L, new UserObject(), null);
        v5.put(5L, new byte[]{/* serialized UserObject bytes */}, null);
        ...
        UserObject obj = v4.get(1L, null); // indistinguishable absent value and null column

        // Optional way
        //        Optional<UserObject> optionalObj = v4.get(1L); // abuse of Optional type

        // NullableValue way
        NullableValue<UserObject> nullableValue = v4.getNullable(1L, null);

        UserObject userObject = v4.get(1L, null); // what if user uses this syntax for nullable column?
        // 1. Exception always
        // 2. Exception if column value is null (use getNullable)

        // Get or default
        String str = v6.getOrDefault(1L, "default", null);

        // ============================  PUT  ===============================================

        v4.put(1L, null, null);
        v4.remove(1L, null, null);
    }
