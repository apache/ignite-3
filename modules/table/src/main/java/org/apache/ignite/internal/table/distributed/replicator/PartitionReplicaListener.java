...
public class PartitionReplicaListener implements ReplicaListener {
    ...
    private MutablePartitionEnlistment createAbandonedTxRecoveryEnlistment(ClusterNode node) {
        // Enlistment consistency token is not required for the rollback, so it is 0L.
        return new MutablePartitionEnlistment(node, 0L, replicationGroupId.tableId());
    }
