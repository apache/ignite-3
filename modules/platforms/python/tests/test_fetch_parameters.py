...
test_data = [
    ...
    pyignite3.TimeFromTicks(0),
    pyignite3.TimeFromTicks(89565),
    pyignite3.Date(1969, 7, 20),
    pyignite3.Date(1525, 1, 1),
    pyignite3.DATE(2024, 9, 12),
    pyignite3.DateFromTicks(0),
    pyignite3.DateFromTicks(8956872365),
    pyignite3.DATETIME(1969, 7, 20, 20, 17, 40),
    pyignite3.DATETIME(2024, 9, 12, 7, 59, 13),
    pyignite3.DATETIME(1000, 1, 1, 0, 0, 0),
    pyignite3.DATETIME(1000, 1, 1, 0, 0, 0),
    pyignite3.Timestamp(1979, 7, 20, 20, 17, 40),
    pyignite3.Timestamp(2024, 9, 12, 7, 59, 13),
