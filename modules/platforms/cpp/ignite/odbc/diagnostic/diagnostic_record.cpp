...
namespace ignite
{
    namespace odbc
    {
        namespace diagnostic
        {
            ...
            DiagnosticRecord::DiagnosticRecord(sql_state sqlState,
            ...
            {
                const std::string& state = Getsql_state();
            ...
            const std::string& DiagnosticRecord::Getsql_state() const
            {
                switch (sqlState)
                {
