...
{
    return m_result == sql_result::AI_SUCCESS ||
        m_result == sql_result::AI_SUCCESS_WITH_INFO;
}

sql_result diagnostic_record_storage::get_field(int32_t rec_num, diagnostic_field field, application_data_buffer& buffer) const
{
    // Header record.
    switch (field)
    {
