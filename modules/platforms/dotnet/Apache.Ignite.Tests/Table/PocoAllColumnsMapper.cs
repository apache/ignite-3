...
public class PocoAllColumnsMapper : IMapper<PocoAllColumns>
{
    public void Write(PocoAllColumns obj, ref RowWriter rowWriter, IMapperSchema schema)
    {
    ...
    public PocoAllColumns Read(ref RowReader rowReader, IMapperSchema schema)
    {
        long key = default;
        string? str = null;
        sbyte int8 = default;
        ...
        return new PocoAllColumns(key, str, int8, int16, int32, int64, @float, @double, uuid, @decimal);
    }
}
