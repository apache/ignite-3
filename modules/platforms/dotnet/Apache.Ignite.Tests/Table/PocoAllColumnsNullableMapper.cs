...
public class PocoAllColumnsNullableMapper : IMapper<PocoAllColumnsNullable>
{
    public void Write(PocoAllColumnsNullable obj, ref RowWriter rowWriter, IMapperSchema schema)
    {
    ...
    public PocoAllColumnsNullable Read(ref RowReader rowReader, IMapperSchema schema)
    {
        long key = default;
        string? str = null;
        sbyte? int8 = null;
        ...
        return new PocoAllColumnsNullable(key, str, int8, int16, int32, int64, @float, @double, uuid, date, time, dateTime, timestamp, blob, @decimal, boolean);
    }
}
