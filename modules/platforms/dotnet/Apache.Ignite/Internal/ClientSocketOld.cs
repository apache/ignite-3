...
namespace Apache.Ignite.Internal
{
    ...
    /// * SSL.
    /// </summary>
    internal sealed class ClientSocketOld : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSocketOld" /> class.
        /// </summary>
        ...
        public void Dispose()
        {
            lock (_disposeSyncRoot)
            {
                ...
                _exception = _exception ?? new ObjectDisposedException(typeof(ClientSocketOld).FullName);
