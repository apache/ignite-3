...
/**
 * Test class for {@link ClusterUnitDeployReplCommand} on non-initialized cluster.
 */
public class ItDeploymentUnitReplNotInitializedTest extends ItDeploymentUnitNonInitilizedTest {
    @Override
