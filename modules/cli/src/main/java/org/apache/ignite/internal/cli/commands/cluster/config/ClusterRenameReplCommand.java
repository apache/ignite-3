...
/**
 * Command that renames the cluster in REPL mode.
 */
@Command(name = "rename", description = "Renames the cluster")
public class ClusterRenameReplCommand extends BaseCommand implements Runnable {
    ...
    private ClusterRenameCallInput renameCallInput(String clusterUrl) {
