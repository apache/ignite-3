...
public class ChangeIndexStatusTaskTest extends IgniteAbstractTest {
    ...
    void setUp() {
        ...
        when(placementDriver.awaitPrimaryReplicaTmp(any(), any(), anyLong(), any())).thenReturn(localNodeReplicaMetaFuture);
    ...
    void testSimpleTaskExecution() {
        ...
        verify(placementDriver).awaitPrimaryReplicaTmp(any(), any(), anyLong(), any());
    ...
    void testTimeoutAndSuccessOnAwaitPrimaryReplica() {
        ...
        when(placementDriver.awaitPrimaryReplicaTmp(any(), any(), anyLong(), any())).thenReturn(
        ...
        verify(placementDriver, times(2)).awaitPrimaryReplicaTmp(any(), any(), anyLong(), any());
    }
