 ...
 */
public class IndexNodeFinishedRwTransactionsChecker implements LocalRwTxCounter, LocalPendingTxMinimalBeginTimeProvider, IgniteComponent {
    ...
    @Override
    public @Nullable HybridTimestamp minimalStartTime() {
