...
public class AlterZoneCommandValidationTest extends AbstractCommandValidationTest {
    ...
    @Test
    void zoneAutoAdjustCompatibility() { // TODO: breaking compatibility?
        // Auto adjust + scale up.
        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(IMMEDIATE_TIMER_VALUE, null),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(INFINITE_TIMER_VALUE, null),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(77, null),
                "Not compatible parameters"
        );
        ...
        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(null, IMMEDIATE_TIMER_VALUE),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(null, INFINITE_TIMER_VALUE),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(null, 88),
                "Not compatible parameters"
        );
        ...
        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(IMMEDIATE_TIMER_VALUE, IMMEDIATE_TIMER_VALUE),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(INFINITE_TIMER_VALUE, INFINITE_TIMER_VALUE),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> alterZoneParams(77, 88),
                "Not compatible parameters"
        );

        // Let's check the success cases.
        alterZoneParams(null, null);
        alterZoneParams(null, null);
        alterZoneParams(null, null);
        alterZoneParams(IMMEDIATE_TIMER_VALUE, IMMEDIATE_TIMER_VALUE);
        alterZoneParams(INFINITE_TIMER_VALUE, INFINITE_TIMER_VALUE);
