...
import static org.apache.ignite.internal.catalog.commands.CatalogUtils.DEFAULT_QUORUM_SIZE;
...
public class AlterZoneCommandValidationTest extends AbstractCommandValidationTest {
    ...
    void zoneQuorumSize(
        ...
        CatalogZoneDescriptor zoneDescriptor = getZoneDescriptor(alterZoneBuilder().replicas(replicas));
        assertThat(zoneDescriptor.quorumSize(), is(DEFAULT_QUORUM_SIZE));
        assertThat(zoneDescriptor.consensusGroupSize(), is(DEFAULT_QUORUM_SIZE * 2 - 1));
