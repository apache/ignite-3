...
public class CreateZoneCommandValidationTest extends AbstractCommandValidationTest {
    ...
    void zoneAutoAdjustCompatibility() { // TODO: breaking compatibility?
        ...
        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(IMMEDIATE_TIMER_VALUE, null),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(INFINITE_TIMER_VALUE, null),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(77, null),
                "Not compatible parameters"
        );
        ...
        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(null, IMMEDIATE_TIMER_VALUE),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(null, INFINITE_TIMER_VALUE),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(null, 88),
                "Not compatible parameters"
        );
        ...
        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(IMMEDIATE_TIMER_VALUE, IMMEDIATE_TIMER_VALUE),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(INFINITE_TIMER_VALUE, INFINITE_TIMER_VALUE),
                "Not compatible parameters"
        );

        assertThrows(
                CatalogValidationException.class,
                () -> createZoneParams(77, 88),
                "Not compatible parameters"
        );
