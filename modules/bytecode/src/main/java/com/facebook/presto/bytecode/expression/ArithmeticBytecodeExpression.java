...
public class ArithmeticBytecodeExpression
    ...
    public static BytecodeExpression createArithmeticBytecodeExpression(OpCode baseOpCode, BytecodeExpression left,
    ...
    private static void checkArgumentTypes(OpCode baseOpCode, String name, BytecodeExpression left, BytecodeExpression right) {
        ...
        switch (baseOpCode) {
            ...
            case IXOR:
                ...
                checkArgument(leftType == int.class || leftType == long.class, "%s argument must be int or long, but is %s", name,
                        leftType);
                return;
            case IADD:
            case ISUB:
            ...
            case ISHR:
            case IUSHR:
                checkArgument(leftType == int.class || leftType == long.class, "%s left argument be int or long, but is %s", name,
                        leftType);
