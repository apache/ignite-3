...
public class FieldDescriptor {
    ...
    /**
     * Returns {@code true} if the field can only host instances of its declared type (and not subtypes),
     ...
     *
     * @return {@code true} if the field can only host instances of the declared type that is known upfront
     */
    public boolean isTypeKnownUpfront() {
