...
/**
 * This class validates SSL configurations.
 */
public class AbstractSslConfigurationValidator {
    /**
     * Validates SSL configuration.
     *
     * @param ctx validation context.
     * @param ssl SSL configuration view.
     */
    public static void validateSsl(ValidationContext<? extends AbstractSslView> ctx, AbstractSslView ssl) {
        if (ssl.enabled()) {
    ...
    private static void validateKeyStore(
            ValidationContext<? extends AbstractSslView> ctx,
            String keyName,
            String type,
            KeyStoreView keyStore
    ) {
