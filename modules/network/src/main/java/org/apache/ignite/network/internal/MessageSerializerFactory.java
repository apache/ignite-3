...
public class MessageSerializerFactory {
    ...
    private final MessageMapperProviders serializerProviders;

    /** Constructor. */
    public MessageSerializerFactory(MessageMapperProviders mappers) {
    ...
    public MessageDeserializer<NetworkMessage> createDeserializer(short directType) {
        return serializerProviders.getProvider(directType).createDeserializer();
    }
    ...
    public MessageSerializer<NetworkMessage> createSerializer(short directType) {
        return serializerProviders.getProvider(directType).createSerializer();
    }
}
