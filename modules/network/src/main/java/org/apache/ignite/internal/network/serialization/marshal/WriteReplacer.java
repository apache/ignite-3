...
/**
 * Replaces objects before serialization using {@code writeReplace()} method.
 *
 * @see Serializable
 * @see Externalizable
 */
class WriteReplacer {
    ...
    DescribedObject applyWriteReplaceIfNeeded(@Nullable Object objectBefore, ClassDescriptor descriptorBefore)
