...
import static org.apache.ignite.internal.processor.configuration.HasFieldMatcher.hasFields;
...
public class ITProcessorTest extends AbstractProcessorTest {
    ...
    @Test
    public void test() {
        final String packageName = "org.apache.ignite.internal.processor.configuration";
