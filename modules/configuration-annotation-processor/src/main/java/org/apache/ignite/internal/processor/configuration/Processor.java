...
package org.apache.ignite.internal.processor.configuration;
...
public class Processor extends AbstractProcessor {
    ...
    private void createGetters(
        ...
        if (Utils.isNamedConfiguration(types.getFieldType())) {
            getMethodBuilder.addAnnotation(Utils.suppressWarningsUnchecked())
...

                {
                    ...
                    if (valAnnotation != null) {
                        ...
                        if (!namedListField) {
                            ...
                            nodeChangeMtdBuilder.addAnnotation(Utils.suppressWarningsUnchecked());
...

                {
                    ...
                    if (valAnnotation != null) {
                        ...
                        if (!namedListField) {
                            ...
                            nodeInitMtdBuilder.addAnnotation(Utils.suppressWarningsUnchecked());
