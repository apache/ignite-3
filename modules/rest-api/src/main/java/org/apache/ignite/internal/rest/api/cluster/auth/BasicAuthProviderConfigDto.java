...
/**
 * REST representation of {@link org.apache.ignite.rest.BasicAuthProviderConfig}.
 */
@JsonTypeName("basic")
@Schema(name = "BasicAuthProviderConfig")
public class BasicAuthProviderConfigDto implements AuthProviderConfigDto {
    ...
    /** Constructor. */
    @JsonCreator
    public BasicAuthProviderConfigDto(
