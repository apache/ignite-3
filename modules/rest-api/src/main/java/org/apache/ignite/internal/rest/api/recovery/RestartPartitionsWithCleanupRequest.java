...
/** Disaster recovery request to restart partitions with clean up. */
@Schema(description = "restart partitions with clean up configuration.")
public class RestartPartitionsWithCleanupRequest {
    @Schema(description = "Names specifying nodes to restart partitions with clean up. Case-sensitive. "
    ...
    /** Constructor. */
    @JsonCreator
    public RestartPartitionsWithCleanupRequest(
