...
/** Disaster recovery request to restart zone partitions with clean up. */
@Schema(description = "restart partitions with clean up configuration.")
public class RestartZonePartitionsWithCleanupRequest {
    @Schema(description = "Names specifying nodes to restart zone partitions with clean up. Case-sensitive. "
    ...
    /** Constructor. */
    @JsonCreator
    public RestartZonePartitionsWithCleanupRequest(
