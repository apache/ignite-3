...
public interface Statement extends AutoCloseable {
    ...
    /**
     * Indicates whether a statement is prepared.
     *
     * @return Whether the statement is prepared.
     */
    boolean prepared();

    /**
     * Returns a statement property value that overrides the session property value; returns {@code null} if the session property value should be used.
     *
    ...
    interface StatementBuilder {
        ...
        /**
         * Marks the current statement as prepared.
         *
         * @param prepared if {@code true} marks the current statement as prepared.
         * @return {@code this} for chaining.
         */
