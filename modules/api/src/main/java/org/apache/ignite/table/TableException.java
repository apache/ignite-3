...
/**
 * Table exception base class.
 */
public class TableException extends IgniteException {
    /**
     * Creates an exception with the given error code.
     *
     * @param code Full error code.
     */
    public TableException(int code) {
        super(code);
    }
     ...
     */
    public TableException(int code, String message) {
        super(code, message);
    }
     ...
     * @param message Detailed message.
     */
    public TableException(UUID traceId, int code, String message) {
     ...
     */
    public TableException(int code, Throwable cause) {
        super(code, cause);
    }
     ...
     * @param cause Optional nested exception (can be {@code null}).
     */
    public TableException(UUID traceId, int code, Throwable cause) {
     ...
     * @param cause Optional nested exception (can be {@code null}).
     */
    public TableException(int code, String message, Throwable cause) {
     ...
     * @param cause Optional nested exception (can be {@code null}).
     */
    public TableException(UUID traceId, int code, String message, Throwable cause) {
