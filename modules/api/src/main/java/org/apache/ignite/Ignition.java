...
public interface Ignition {
     ...
     *
     * @param nodeName Name of the node the initialization request is sent to.
     * @param metaStorageNodeNames Names of the nodes that will host Meta Storage <b>and</b> CMG.
     ...
     *
     * @param nodeName Name of the node the initialization request is sent to.
     * @param metaStorageNodeNames Names of nodes that will host Meta Storage.
     * @param cmgNodeNames Names of nodes that will host CMG.
     * @param clusterName Human-readable name of the cluster.
     * @throws IgniteException If the given node has not been started or has been stopped.
     * @see <a href="https://cwiki.apache.org/confluence/display/IGNITE/IEP-77%3A+Node+Join+Protocol+and+Initialization+for+Ignite+3">IEP-77</a>
     */
