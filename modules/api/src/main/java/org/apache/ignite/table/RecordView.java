...
public interface RecordView<R> {
     ...
     * @return Records with all columns filled from the table. The order of collection elements
     * is guaranteed to be the same as the order of {@param keyRecs}. If a record does not exist,
     * the element at the corresponding index of the resulting collection will be null.
     */
