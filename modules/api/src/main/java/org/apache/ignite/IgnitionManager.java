...
public class IgnitionManager {
    ...
    /**
     * Stops the node identified by {@code nodeName}. It is possible to stop both running nodes and the node that are currently starting. No action is taken if the specified node doesn't exist.
     *
     ...
     *
     * @param nodeName Name of the node the initialization request will be sent to.
     * @param metaStorageNodeNames Names of the nodes that will host Meta Storage and CMG.
     * @param clusterName Human-readable name of the cluster.
     * @throws IgniteException If the specified node has not been started or has been stopped.
     ...
     * @param metaStorageNodeNames Names of the nodes that will host Meta Storage.
     * @param cmgNodeNames Names of the nodes that will host CMG.
     * @param clusterName Human-readable name of the cluster.
