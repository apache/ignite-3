...
public interface SessionBuilder {
     ...
     */
    SessionBuilder withDefaultTimeout(long timeout, TimeUnit timeUnit);
     ...
     */
    SessionBuilder withDefaultSchema(String schema);
     ...
     */
    SessionBuilder withDefaultPageSize(int pageSize);
     ...
     * @return {@code this} for chaining.
     */
    SessionBuilder withProperty(String name, @Nullable Object value);
