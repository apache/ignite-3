...
public class ClusterInitializer {
    ...
    public CompletableFuture<Void> initCluster(
        ...
        return initCluster(metaStorageNodeNames, cmgNodeNames, clusterName, disabledAuth());
    }
    ...
    public CompletableFuture<Void> initCluster(
        ...
        try {
            ...
            CmgInitMessage initMessage = msgFactory.cmgInitMessage()
                    ...
                    .restAuthToApply(RestAuth.restAuth(msgFactory, restAuthConfig))
                    .build();
