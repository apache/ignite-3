...
class CmgInitMessageTest {
    ...
    void toStringDoesNotContainInitConfiguration() {
        ...
        CmgInitMessage message = new CmgMessagesFactory()
                .cmgInitMessage()
                .clusterName("Name")
                .clusterId(UUID.randomUUID())
                .cmgNodes(emptySet())
                .metaStorageNodes(emptySet())
                .initialClusterConfiguration(initClusterConfiguration)
                .build();

        assertThat(message.toString(), not(containsString(initClusterConfiguration)));
    }
}
