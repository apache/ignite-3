...
public class ConfigurationTreeComparatorSelfTest {
    ...
    private static ConfigNode createInstanceNode(String name, String instanceType) {
        return new ConfigNode(
                null,
                Map.of(Attributes.NAME, name, Attributes.CLASS, name + "Class", Attributes.POLYMORPHIC_INSTANCE_ID, instanceType),
                List.of(),
