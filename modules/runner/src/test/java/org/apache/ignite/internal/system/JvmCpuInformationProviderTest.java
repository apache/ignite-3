...
public class JvmCpuInformationProviderTest extends BaseIgniteAbstractTest {
    ...
    void availableProcessorsIsPositiveNumberTest() {
        JvmCpuInformationProvider cpuInformationProvider = new JvmCpuInformationProvider();

        assertThat(cpuInformationProvider.availableProcessors(), is(greaterThanOrEqualTo(1)));
    }
    ...
    void availableProcessorsAreCalculatedTheSameAsJvmRuntime() {
        ...
        assertThat(cpuInformationProvider.availableProcessors(), is(Runtime.getRuntime().availableProcessors()));
    }
}
