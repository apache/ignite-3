 ...
 */
public class HybridClockOriginalSystemUTC implements HybridClock {
    private final IgniteLogger log = Loggers.forClass(HybridClockOriginalSystemUTC.class);
    ...
    static {
        try {
            LATEST_TIME = MethodHandles.lookup().findVarHandle(HybridClockOriginalSystemUTC.class, "latestTime", long.class);
     ...
     */
    public HybridClockOriginalSystemUTC() {
