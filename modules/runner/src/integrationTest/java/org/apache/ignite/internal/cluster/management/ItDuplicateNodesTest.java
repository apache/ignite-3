...
public class ItDuplicateNodesTest extends BaseIgniteAbstractTest {
    ...
    private static IgniteServer startEmbeddedNode(TestInfo testInfo, int nodeIndex, int nodesCount) {
        ...
        return TestIgnitionManager.start(
