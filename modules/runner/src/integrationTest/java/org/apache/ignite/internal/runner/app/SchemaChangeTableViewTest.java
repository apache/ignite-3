...
class SchemaChangeTableViewTest extends AbstractSchemaChangeTest {
    ...
    public void testDropColumn() {
        checkDropColumn(
                ...
                (grid) -> {
                    ...
                    tbl.insert(tbl.tupleBuilder().set("key", 2L).set("val1", 222).build());
    ...
    public void testAddNewColumn() {
        checkAddNewColumn(
                SchemaBuilders.column("val2", ColumnType.string())
                        .asNullable()
                ...
                grid -> {
                    ...
                    assertEquals(111, (Integer) tbl.get(keyTuple1).value("val1"));
    ...
    void testRenameColumn() {
        checkRenameColumn(
                ...
                grid -> {
                    ...
                    assertThrows(ColumnNotFoundException.class, () -> tbl.get(keyTuple1).value("val1"));
                    ...
                    assertThrows(ColumnNotFoundException.class, () -> tbl.get(keyTuple2).value("val1"));
                });
    }
}
