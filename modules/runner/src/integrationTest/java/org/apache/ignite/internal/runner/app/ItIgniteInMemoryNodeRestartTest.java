...
public class ItIgniteInMemoryNodeRestartTest extends BaseIgniteRestartTest {
    ...
    public void inMemoryNodeRestartNotLeader(TestInfo testInfo) throws Exception {
        ...
        TableView table = (TableView) ignite.tables().table(TABLE_NAME);
        ...
        TableView restartingTable = (TableView) restartingNode.tables().table(TABLE_NAME);
    ...
    private static boolean isRaftNodeStarted(TableView table, Loza loza) {
    ...
    public void inMemoryNodeRestartNoMajority(TestInfo testInfo) throws Exception {
        ...
        TableView table = (TableView) ignite0.tables().table(TABLE_NAME);
    ...
    private static void createTableWithData(Ignite ignite, String name, int replicas, int partitions) throws InterruptedException {
        ...
        var table = (TableView) ignite.tables().table(name);
    ...
    private static boolean tableHasDataOnAllIgnites(String name, int partitions) {
        return CLUSTER_NODES.stream()
                .allMatch(igniteNode -> tableHasAnyData((TableView) igniteNode.tables().table(name), partitions));
    }

    private static boolean tableHasAnyData(TableView nodeTable, int partitions) {
