...
public class LargeBinaryKvBenchmark extends AbstractMultiNodeBenchmark {
    ...
    public void setUp() {
        ...
        String stmt = format("CREATE TABLE t (id INT PRIMARY KEY, val VARBINARY({}))", Integer.MAX_VALUE);
        ...
        keyValueView = tables.table("public.t").keyValueView(Integer.class, byte[].class);
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(".*" + LargeBinaryKvBenchmark.class.getSimpleName() + ".*")
                .build();
