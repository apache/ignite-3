...
public class UpsertKVBenchmark extends AbstractMultiNodeBenchmark {
    ...
    public void nodeSetUp() throws Exception {
        System.setProperty(IgniteSystemProperties.SKIP_REPLICATION_IN_BENCHMARK, "true");
        System.setProperty(IgniteSystemProperties.SKIP_STORAGE_UPDATE_IN_BENCHMARK, "true");
        super.nodeSetUp();
    }
