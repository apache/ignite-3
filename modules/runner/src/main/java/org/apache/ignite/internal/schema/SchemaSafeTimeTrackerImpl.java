...
public class SchemaSafeTimeTrackerImpl implements SchemaSafeTimeTracker, IgniteComponent, NotificationEnqueuedListener {
    ...
    /*
     * We rely on the fact that NotificationEnqueuedListener#onEnqueued() is executed under lock, so in this method we don't need
     * additional synchronization when accessing this field.
     */
