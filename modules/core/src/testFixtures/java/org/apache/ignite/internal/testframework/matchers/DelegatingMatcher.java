...
/**
 * Matches an object against a delegate matcher, transforming the object before matching.
 *
 * @param <O> Object type.
...
public class DelegatingMatcher<O, T> extends TypeSafeMatcher<O> {
    ...
    public static <O, T> DelegatingMatcher<O, T> has(Function<O, T> transformer, Matcher<T> delegate) {
