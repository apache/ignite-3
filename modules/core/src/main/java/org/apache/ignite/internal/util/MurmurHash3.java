 ...
 *
 * <p>Copy-pasted from https://commons.apache.org/proper/commons-codec/jacoco/org.apache.commons.codec.digest/MurmurHash3.java.html.
...
public class MurmurHash3 {
    ...
    public static class IncrementalHash32x86 {
        ...
        /**
         * Combines the bytes using an Or operation ({@code | } in a little-endian representation of a 32-bit integer; byte 1 will be the
         * least significant byte, byte 4 the most significant.
         *
