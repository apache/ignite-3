...
public class RaftGroupConfiguration implements Serializable {
    ...
    private final long casualityToken;
    ...
    public boolean equals(Object o) {
        ...
        return index == that.index && term == that.term && casualityToken == that.casualityToken
    ...
    @Override
    public int hashCode() {
        return Objects.hash(index, term, casualityToken, peers, learners, oldPeers, oldLearners);
    }
