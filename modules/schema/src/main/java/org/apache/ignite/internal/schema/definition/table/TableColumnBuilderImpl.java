 ...
 * Column builder.
 */
public class TableColumnBuilderImpl implements ColumnBuilder {
    /** Column name. */
    ...
    /** {@inheritDoc} */
    @Override public TableColumnBuilderImpl withDefaultValueExpression(Object defValExpr) {
    ...
    @Override public Column build() {
        return new ColumnImpl(colName, colType, nullable, defValExpr);
    }
}
