...
import org.apache.ignite.internal.schema.row.InnerTuple;
...
public enum NativeTypeSpec {
    ...
    INT8("int8", true) {
        /** {@inheritDoc} */
        @Override
        public Object objectValue(InnerTuple tup, int colIdx) {
     ...
     */
    public abstract Object objectValue(InnerTuple row, int colIdx) throws InvalidTypeException;
