...
import org.apache.ignite.internal.schema.row.AbstractTuple;
...
public enum NativeTypeSpec {
    ...
    INT8("int8", true) {
        /** {@inheritDoc} */
        @Override
        public Object objectValue(AbstractTuple tup, int colIdx) {
     ...
     */
    public abstract Object objectValue(AbstractTuple row, int colIdx) throws InvalidTypeException;
