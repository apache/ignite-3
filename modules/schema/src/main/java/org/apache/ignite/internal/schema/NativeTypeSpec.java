...
import org.apache.ignite.internal.schema.row.BinaryTuple;
...
public enum NativeTypeSpec {
    ...
    INT8("int8", true) {
        /** {@inheritDoc} */
        @Override
        public Object objectValue(BinaryTuple tup, int colIdx) {
     ...
     */
    public abstract Object objectValue(BinaryTuple row, int colIdx) throws InvalidTypeException;
