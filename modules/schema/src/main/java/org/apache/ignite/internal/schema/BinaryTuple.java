...
/**
 * Utility for access to the values of a binary tuple.
 */
public class BinaryTuple extends BinaryTupleParser {
     ...
     */
    public BinaryTuple(int numElements, byte[] bytes) {
     ...
     */
    public BinaryTuple(int numElements, ByteBuffer buffer) {
