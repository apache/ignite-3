...
public class RowAssemblerSimpleSchemaTest {
    ...
    public void fixedKeyFixedNullableValue() {
        ...
        // No value.
        assertRowBytesEquals(
            new byte[] {42, 0, 11, 0, 33, 0, 0, 0, 8, 0, 0, 0, 33, 0, 0, 0},
    ...
    public void fixedKeyFixedValue() {
        ...
        // No value.
        assertRowBytesEquals(
            new byte[] {42, 0, 11, 0, 33, 0, 0, 0, 6, 0, 0, 0, 33, 0},
    ...
    public void fixedNullableKeyFixedValue() {
        ...
        // No value.
        assertRowBytesEquals(
            new byte[] {42, 0, 9, 0, 33, 0, 0, 0, 7, 0, 0, 0, 0, 33, 0},
            new RowAssembler(schema, 0, 0, 0)
                .appendShort((short)33)
                .build());
    }
    ...
    public void fixedNullableKeyVarlenValue() {
        ...
        // No value.
        assertRowBytesEquals(
            new byte[] {42, 0, 9, 0, 33, 0, 0, 0, 6, 0, 0, 0, 0, 33},
            new RowAssembler(schema, 0, 0, 0)
                .appendByte((byte)33)
                .build());
    }
    ...
    public void varlenKeyFixedNullableValue() {
        ...
        // No value.
        assertRowBytesEquals(
            new byte[] {42, 0, 11, 0, 95, -98, 1, 0, 7, 0, 0, 0, 107, 101, 121},
            new RowAssembler(schema, 0, 1, 0)
                .appendString("key")
                .build());
    ...
    public void varlenNullableKeyFixedNullableValue() {
        ...
        // No value.
        assertRowBytesEquals(
            new byte[] {42, 0, 9, 0, 95, -98, 1, 0, 8, 0, 0, 0, 0, 107, 101, 121},
            new RowAssembler(schema, 0, 1, 0)
                .appendString("key")
                .build());
