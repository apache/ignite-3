...
public class UnionPlannerTest extends AbstractPlannerTest {
    ...
    public void testUnion() throws Exception {
        ...
        assertPlan(sql, publicSchema, isInstanceOf(IgniteExchange.class)
                .and(hasChildThat(isInstanceOf(IgniteColocatedHashAggregate.class).and(hasChildThat(isInstanceOf(Union.class)))))
        );
        assertPlan(sql, publicSchema, isInstanceOf(IgniteExchange.class).and(hasChildThat(isInstanceOf(IgniteColocatedHashAggregate.class)
