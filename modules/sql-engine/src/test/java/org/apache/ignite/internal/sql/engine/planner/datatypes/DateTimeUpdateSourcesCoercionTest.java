...
public class DateTimeUpdateSourcesCoercionTest extends BaseTypeCoercionTest {
    ...
    public void updateWithLiteralValue(
        ...
        String val = generateLiteral(pair.second(), false);
    ...
    private static Stream<Arguments> argsForUpdateWithColumnAsValue() {
        ...
        diff.put(DatetimePair.TIMESTAMP_0_TIMESTAMP_WLTZ_0, forTypePair(DatetimePair.TIMESTAMP_0_TIMESTAMP_WLTZ_0)
                .opMatches(castTo(Types.TIMESTAMP_0)));
        diff.put(DatetimePair.TIMESTAMP_0_TIMESTAMP_WLTZ_1, forTypePair(DatetimePair.TIMESTAMP_0_TIMESTAMP_WLTZ_1)
                .opMatches(castTo(Types.TIMESTAMP_0)));
        ...
        diff.put(DatetimePair.TIMESTAMP_WLTZ_0_TIMESTAMP_0, forTypePair(DatetimePair.TIMESTAMP_WLTZ_0_TIMESTAMP_0)
                .opMatches(castTo(Types.TIMESTAMP_WLTZ_0)));
        diff.put(DatetimePair.TIMESTAMP_WLTZ_0_TIMESTAMP_1, forTypePair(DatetimePair.TIMESTAMP_WLTZ_0_TIMESTAMP_1)
                .opMatches(castTo(Types.TIMESTAMP_WLTZ_0)));
        ...
        diff.put(DatetimePair.TIMESTAMP_WLTZ_1_TIMESTAMP_0, forTypePair(DatetimePair.TIMESTAMP_WLTZ_1_TIMESTAMP_0)
                .opMatches(castTo(Types.TIMESTAMP_WLTZ_1)));
        diff.put(DatetimePair.TIMESTAMP_WLTZ_1_TIMESTAMP_1, forTypePair(DatetimePair.TIMESTAMP_WLTZ_1_TIMESTAMP_1)
                .opMatches(castTo(Types.TIMESTAMP_WLTZ_1)));
        diff.put(DatetimePair.TIMESTAMP_WLTZ_1_TIMESTAMP_9, forTypePair(DatetimePair.TIMESTAMP_WLTZ_1_TIMESTAMP_9)
                .opMatches(castTo(Types.TIMESTAMP_WLTZ_1)));
