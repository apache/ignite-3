...
public enum DifferentFamiliesPair implements TypePair {
    ...
    TINYINT_TIMESTAMP_3(NativeTypes.INT8, Types.TIMESTAMP_9),
    TINYINT_TIMESTAMP_WLTZ_3(NativeTypes.INT8, Types.TIMESTAMP_WLTZ_9),
    ...
    SMALLINT_TIME_3(NativeTypes.INT16, Types.TIME_9),
    SMALLINT_TIMESTAMP_3(NativeTypes.INT16, Types.TIMESTAMP_9),
    SMALLINT_TIMESTAMP_WLTZ_3(NativeTypes.INT16, Types.TIMESTAMP_WLTZ_9),
    ...
    INT_TIME_3(NativeTypes.INT32, Types.TIME_9),
    INT_TIMESTAMP_3(NativeTypes.INT32, Types.TIMESTAMP_9),
    INT_TIMESTAMP_WLTZ_3(NativeTypes.INT32, Types.TIMESTAMP_WLTZ_9),
    ...
    BIGINT_TIME_3(NativeTypes.INT64, Types.TIME_9),
    BIGINT_TIMESTAMP_3(NativeTypes.INT64, Types.TIMESTAMP_9),
    BIGINT_TIMESTAMP_WLTZ_3(NativeTypes.INT64, Types.TIMESTAMP_WLTZ_9),
    ...
    DECIMAL_4_2_TIME_3(Types.DECIMAL_4_2, Types.TIME_9),
    DECIMAL_4_2_TIMESTAMP_3(Types.DECIMAL_4_2, Types.TIMESTAMP_9),
    DECIMAL_4_2_TIMESTAMP_WLTZ_3(Types.DECIMAL_4_2, Types.TIMESTAMP_WLTZ_9),
    ...
    REAL_TIME_3(NativeTypes.FLOAT, Types.TIME_9),
    REAL_TIMESTAMP_3(NativeTypes.FLOAT, Types.TIMESTAMP_9),
    REAL_TIMESTAMP_WLTZ_3(NativeTypes.FLOAT, Types.TIMESTAMP_WLTZ_9),
    ...
    DOUBLE_TIME_3(NativeTypes.DOUBLE, Types.TIME_9),
    DOUBLE_TIMESTAMP_3(NativeTypes.DOUBLE, Types.TIMESTAMP_9),
    DOUBLE_TIMESTAMP_WLTZ_3(NativeTypes.DOUBLE, Types.TIMESTAMP_WLTZ_9),
    ...
    VARCHAR_3_TIME_3(Types.VARCHAR_128, Types.TIME_9),
    VARCHAR_3_TIMESTAMP_3(Types.VARCHAR_128, Types.TIMESTAMP_9),
    VARCHAR_3_TIMESTAMP_WLTZ_3(Types.VARCHAR_128, Types.TIMESTAMP_WLTZ_9),
    ...
    DATE_TIME_3(NativeTypes.DATE, Types.TIME_9),
    DATE_TIMESTAMP_3(NativeTypes.DATE, Types.TIMESTAMP_9),
    DATE_TIMESTAMP_WLTZ_3(NativeTypes.DATE, Types.TIMESTAMP_WLTZ_9),
    ...
    TIME_3_TIMESTAMP_3(Types.TIME_9, Types.TIMESTAMP_9),
    TIME_3_TIMESTAMP_WLTZ_3(Types.TIME_9, Types.TIMESTAMP_WLTZ_9),
    TIME_3_BOOLEAN(Types.TIME_9, NativeTypes.BOOLEAN),
    TIME_3_UUID(Types.TIME_9, NativeTypes.UUID),
    TIME_3_VARBINARY_3(Types.TIME_9, Types.VARBINARY_128),

    TIMESTAMP_3_BOOLEAN(Types.TIMESTAMP_9, NativeTypes.BOOLEAN),
    TIMESTAMP_3_UUID(Types.TIMESTAMP_9, NativeTypes.UUID),
    TIMESTAMP_3_VARBINARY_3(Types.TIMESTAMP_9, Types.VARBINARY_128),

    TIMESTAMP_WLTZ_3_BOOLEAN(Types.TIMESTAMP_WLTZ_9, NativeTypes.BOOLEAN),
    TIMESTAMP_WLTZ_3_UUID(Types.TIMESTAMP_WLTZ_9, NativeTypes.UUID),
    TIMESTAMP_WLTZ_3_VARBINARY_3(Types.TIMESTAMP_WLTZ_9, Types.VARBINARY_128),
