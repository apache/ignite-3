 ...
 * static except that it inherits from {@link RexExecutor}. This pretends that other code in the project assumes the
 * executor instance is {@link RexExecutorImpl}.
 */
public class RexExecutorImpl implements RexExecutor {
    ...
    /**
     * Creates an {@link RexExecutable} that allows to apply the generated code during query processing (filter,
     * projection).
     *
     ...
     */
    public static RexExecutable getExecutable(
            RexBuilder rexBuilder,
            List<RexNode> exps,
            RelDataType rowType
    ) {
    ...
    /**
     * Implementation of {@link org.apache.calcite.adapter.enumerable.RexToLixTranslator.InputGetter} that reads the
     * values of input fields by calling
