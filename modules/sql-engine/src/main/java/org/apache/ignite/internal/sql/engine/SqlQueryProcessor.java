...
public class SqlQueryProcessor implements QueryProcessor {
    ...
    public CompletableFuture<AsyncSqlCursor<InternalSqlRow>> queryAsync(
        ...
        if (cancellationToken != null && CancelHandleHelper.isCancelled(cancellationToken)) {
            throw new SqlException(EXECUTION_CANCELLED_ERR, QueryCancelledException.CANCEL_MSG);
        }
        ...
        try {
            ...
            if (Commons.isMultiStatementQueryAllowed(properties0)) {
                ...
                return querySingle(properties0, txContext, cancellationToken, qry, params);
            }
        } finally {
            busyLock.leaveBusy();
        }
