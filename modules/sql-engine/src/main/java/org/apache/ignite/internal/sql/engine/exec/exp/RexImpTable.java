 ...
 * 1. Removed original ROUND, TRUNCATE, TRUNC_BIG_QUERY, LN, LOG, LOG10 functions
 * 2. populateIgnite()
...
/*    private QuantifyCollectionImplementor defineQuantify(
    ...
    void populate1() {
      ...
      define(LOG_POSTGRES, new LogImplementor());
      define(LOG_MYSQL, new LogImplementor());
      define(LOG2, new LogImplementor());
...
/*      defineWinAgg(RANK, RankImplementor.class);
    ...
    void populateIgnite() {
      ...
      define(LOG10, new LogImplementor());
