...
import static org.apache.ignite.internal.sql.engine.sql.fun.IgniteSqlOperatorTable.GROUPING;
...
public class RexImpTable {
    ...
    private static class ExtractImplementor extends AbstractRexCallImplementor {
        ...
        @Override Expression implementSafe(final RexToLixTranslator translator,
            ...
            operand = mod(operand, getFactor(unit), unit == TimeUnit.QUARTER || !isIntervalType); // todo calcite issue ?
    ...
    private static class NotImplementor extends AbstractRexCallImplementor {
        ...
        private NotImplementor(AbstractRexCallImplementor implementor) {
            super(implementor.nullPolicy, false); // todo calcite issue?
