...
public class AsyncResultSetImpl<T> implements AsyncResultSet<T> {
    ...
    static class SqlRowImpl implements SqlRow, BinaryTupleContainer {
        ...
        public boolean booleanValue(String columnName) {
            return (boolean) ensureNotNull(row.get(columnIndexChecked(columnName)));
        }

        /** {@inheritDoc} */
        @Override
        public boolean booleanValue(int columnIndex) {
            return (boolean) ensureNotNull(row.get(columnIndex));
        }

        /** {@inheritDoc} */
        @Override
        public byte byteValue(String columnName) {
            return (byte) ensureNotNull(row.get(columnIndexChecked(columnName)));
        }

        /** {@inheritDoc} */
        @Override
        public byte byteValue(int columnIndex) {
            return (byte) ensureNotNull(row.get(columnIndex));
        }

        /** {@inheritDoc} */
        @Override
        public short shortValue(String columnName) {
            return (short) ensureNotNull(row.get(columnIndexChecked(columnName)));
        }

        /** {@inheritDoc} */
        @Override
        public short shortValue(int columnIndex) {
            return (short) ensureNotNull(row.get(columnIndex));
        }

        /** {@inheritDoc} */
        @Override
        public int intValue(String columnName) {
            return (int) ensureNotNull(row.get(columnIndexChecked(columnName)));
        }

        /** {@inheritDoc} */
        @Override
        public int intValue(int columnIndex) {
            return (int) ensureNotNull(row.get(columnIndex));
        }

        /** {@inheritDoc} */
        @Override
        public long longValue(String columnName) {
            return (long) ensureNotNull(row.get(columnIndexChecked(columnName)));
        }

        /** {@inheritDoc} */
        @Override
        public long longValue(int columnIndex) {
            return (long) ensureNotNull(row.get(columnIndex));
        }

        /** {@inheritDoc} */
        @Override
        public float floatValue(String columnName) {
            return (float) ensureNotNull(row.get(columnIndexChecked(columnName)));
        }

        /** {@inheritDoc} */
        @Override
        public float floatValue(int columnIndex) {
            return (float) ensureNotNull(row.get(columnIndex));
        }

        /** {@inheritDoc} */
        @Override
        public double doubleValue(String columnName) {
            return (double) ensureNotNull(row.get(columnIndexChecked(columnName)));
        }

        /** {@inheritDoc} */
        @Override
        public double doubleValue(int columnIndex) {
            return (double) ensureNotNull(row.get(columnIndex));
        }
