...
class RowNamespace implements SqlValidatorNamespace {
    private final SqlValidator validator;
    private final RelDataType type;

    RowNamespace(SqlValidator validator, RelDataType type) {
    ...
    public @Nullable SqlValidatorNamespace lookupChild(String name) {
        ...
        RelDataTypeField field = nameMatcher.field(type, name);
        if (field == null) {
            return null;
        }

        return new RowFieldNamespace(validator, field.getType());
    }
