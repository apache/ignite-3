...
import static org.apache.ignite.lang.ErrorGroups.Sql.DEL_PK_COLUMN_CONSTRAINT_ERR;
                    ...
                    chng.changeColumns(cols -> {
                        ...
                        for (String colName : colNames) {
                            ...
                            if (primaryCols.contains(colName)) {
                                throw new SqlException(DEL_PK_COLUMN_CONSTRAINT_ERR, IgniteStringFormatter
