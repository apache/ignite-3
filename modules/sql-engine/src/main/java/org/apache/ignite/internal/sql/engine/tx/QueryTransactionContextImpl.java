...
public class QueryTransactionContextImpl implements QueryTransactionContext {
    ...
    private volatile Consumer<UUID> implicitTxStartCallback = ignored -> {};
    ...
    @Override
    public void setImplicitTxStartCallback(Consumer<UUID> callback) {
        implicitTxStartCallback = callback;
    }
    ...
    public QueryTransactionWrapper getOrStartImplicit(boolean readOnly) {
        ...
        if (tx == null) {
            ...
            implicitTxStartCallback.accept(transaction.id());
