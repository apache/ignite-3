 ...
 */
public class IgniteSqlAlterZone extends IgniteAbstractSqlAlterZone {
    ...
    protected static class Operator extends IgniteDdlOperator {
        ...
        public SqlCall createCall(@Nullable SqlLiteral functionQualifier, SqlParserPos pos, @Nullable SqlNode... operands) {
            return new IgniteSqlAlterZone(pos, (SqlIdentifier) operands[0], (SqlNodeList) operands[1], existFlag());
        }
    }
    ...
    /** Constructor. */
    public IgniteSqlAlterZone(SqlParserPos pos, SqlIdentifier name, SqlNodeList optionList, boolean ifExists) {
        super(new IgniteSqlAlterZone.Operator(ifExists), pos, name);
