...
public class RebalanceRaftGroupEventsListener implements RaftGroupEventsListener {
     ...
     */
    private void scheduleChangePeersAndLearners(PeersAndLearners peersAndLearners, long term, long casualityToken) {
        rebalanceScheduler.schedule(() -> {
            ...
            try {
                partitionMover.movePartition(peersAndLearners, term, casualityToken)
