...
public class RebalanceUtilUpdateAssignmentsTest extends IgniteAbstractTest {
    ...
    private static final Set<Assignment> assignments3 = calculateAssignmentForPartition(nodes3, partNum + 1, partNum, replicas);
    private static final Set<Assignment> assignments4 = calculateAssignmentForPartition(nodes4, partNum + 1, partNum, replicas);
