...
/**
 * Local transactions facade implementation.
 */
public class IgniteLocalTransactionsImpl implements IgniteTransactions {
     ...
     */
    public IgniteLocalTransactionsImpl(TxManager txManager) {
    ...
    public Transaction begin(@Nullable TransactionOptions options) {
        ...
        return txManager.beginLocal(options != null && options.readOnly());
    }
