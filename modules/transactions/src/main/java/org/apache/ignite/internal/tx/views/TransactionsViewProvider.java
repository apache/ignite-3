...
public class TransactionsViewProvider {
    ...
    public void init(Iterable<TxInfo> dataSource) {
    ...
    public SystemView<?> get() {
        ...
        return SystemViews.<TxInfo>nodeViewBuilder()
                ...
                .<String>addColumn("STATE", stringType, TxInfo::state)
                .<String>addColumn("ID", stringType, TxInfo::id)
                .<Instant>addColumn("START_TIME", timestampType, TxInfo::startTime)
                .<String>addColumn("TYPE", stringType, TxInfo::type)
                .<String>addColumn("PRIORITY", stringType, TxInfo::priority)
