 ...
 *
 * <p>Lock waiters are placed in the queue, ordered according to comparator provided by {@link HeapLockManagerV2#deadlockPreventionPolicy}.
 ...
 */
public class HeapLockManagerV2 extends AbstractEventProducer<LockEvent, LockEventParameters> implements LockManager {
    /** Table size. */
    ...
    /**
     * Creates an instance of {@link HeapLockManagerV2} with a few slots eligible for tests which don't stress the lock manager too much.
     * Such a small instance is started way faster than a full-blown production ready instance with a lot of slots.
     */
    @TestOnly
    public static HeapLockManagerV2 smallInstance() {
        return new HeapLockManagerV2(1024, 1024);
    }

    /** Constructor. */
    public HeapLockManagerV2(SystemLocalConfiguration systemProperties) {
        this(
     ...
     */
    public HeapLockManagerV2(int rawSlotsMaxSize, int lockMapSize) {
