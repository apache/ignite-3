...
public class TxRecovery {
    ...
    private final Function<ClusterNode, MutablePartitionEnlistment> abandonedTxRecoveryEnlistmentFactory;
    ...
    public TxRecovery(
            ...
            Function<ClusterNode, MutablePartitionEnlistment> abandonedTxRecoveryEnlistmentFactory
    ) {
