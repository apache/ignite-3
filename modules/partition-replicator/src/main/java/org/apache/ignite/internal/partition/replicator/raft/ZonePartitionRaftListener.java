...
public class ZonePartitionRaftListener implements RaftGroupListener {
    ...
    private CommandResult processTableAwareCommand(
        ...
        if (tableProcessor == null) {
            ...
            // while being replicated and arrived on this node after the target table had been removed. In this case we ignore the command,
            // which should be safe to do, because the underlying storage was destroyed anyway.
