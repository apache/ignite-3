...
/**
 * Tests for {@link RocksDbDataRegion}.
 */
@ExtendWith(ConfigurationExtension.class)
public class RocksDbDataRegionTest {

    @Test
    void testCreateWriteBufferManager(
        ...
        StorageEngine engine = new RocksDbStorageEngine();
        ...
        try {
            ...
            WriteBufferManager writeBufferManager = ((RocksDbDataRegion) dataRegion).writeBufferManager();

            assertTrue(writeBufferManager.allowStall());
        } finally {
