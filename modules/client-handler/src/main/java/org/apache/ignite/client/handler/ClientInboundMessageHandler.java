...
import org.apache.ignite.client.handler.requests.table.partition.ClientPrimaryPartitionsToNodesGetRequest;
    ...
    private @Nullable CompletableFuture processOperation(
        ...
        switch (opCode) {
            ...
            case ClientOp.PARTITIONS_PRIMARY_GET:
                return ClientPrimaryPartitionsToNodesGetRequest.process(in, out, igniteTables);
            default:
