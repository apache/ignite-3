...
object RunAllTests : BuildType({
    ...
    params {
        ...
        checkbox("reverse.dep.*.IGNITE_ZONE_BASED_REPLICATION", "-DIGNITE_ZONE_BASED_REPLICATION=true", label = "Enable Zone-based replication", checked = "-DIGNITE_ZONE_BASED_REPLICATION=true", unchecked = "-DIGNITE_ZONE_BASED_REPLICATION=false")
